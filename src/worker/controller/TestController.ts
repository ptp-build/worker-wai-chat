...
export default async function(request:Request){
  ...
  switch (action){
    ...
    case "protoUser":
      ...
      break
    case "protoChat":
      const c:any = {"type":"chatTypePrivate","id":"4002","title":"Bot Father","usernames":[],"isMuted":false,"isMin":false,"hasPrivateLink":false,"isSignaturesShown":false,"accessHash":"","isVerified":false,"isJoinToSend":false,"isJoinRequest":false,"isForum":false,"isListed":true,"settings":{"isAutoArchived":false,"canReportSpam":false,"canAddContact":false,"canBlockContact":false}}
      const obj = new Chat()
      obj.setChatInfo(c)
      await obj.save();
